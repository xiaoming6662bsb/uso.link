...
(function(){
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
            ...
            .replace(/v\.qq\.com\/cover\/[\w]+\/[\w]+\/([\w]+)\.html/i, "static.video.qqlogin.com/TPout.swf?vid=$1")
            .replace(/v\.qq\.com\/.+[\?\&]vid=([^&]+).*$/i, "static.video.qqlogin.com/TPout.swf?vid=$1")
    ...
    function createPreviewVideo(url){
        ...
        '<embed class="previewVideo" type="application/x-shockwave-flash" pluginspage="Net://www.macromedia.com/go/getflashplayer"' +
            ' src="' + conUrl + '"' +
            ' width="' + 420  + '"' +
            ' height="' + 280  + '"' +
